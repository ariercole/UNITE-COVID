...
working.df$INC_SEX_RAD <- with(working.df, ifelse(INC_SEX_RAD == 2, 
                                                         "Female", INC_SEX_RAD))
working.df$INC_SEX_RAD <- with(working.df, ifelse(INC_SEX_RAD == 3, 
                                                         NA, INC_SEX_RAD))
working.df$INC_SEX_RAD <- with(working.df, ifelse(INC_SEX_RAD == 'ND', 
                                                         NA, INC_SEX_RAD)) 
...
#ICU_ADM_DIAG_YN
## Filled only if ICU_ADM_DIAG_RAD = Other diagnosis	3
working.df$ICU_ADM_DIAG_YN <- ifelse(working.df$ICU_ADM_DIAG_YN == '', NA, working.df$ICU_ADM_DIAG_YN)
working.df$ICU_ADM_DIAG_YN <- as.factor(working.df$ICU_ADM_DIAG_YN)
...
#ICU_RESP_SUPPORT_YN
#Did the patient receive respiratory support before ICU admission?
## Yes	1
## No	0
## Unknown	2
### Seems OK
...
working.df$ICU_TEMPERATURE_DEC <- ifelse(as.numeric(working.df$ICU_TEMPERATURE_DEC) <33, NA, working.df$ICU_TEMPERATURE_DEC)
working.df$ICU_TEMPERATURE_DEC <- ifelse(as.numeric(working.df$ICU_TEMPERATURE_DEC) >42, NA, working.df$ICU_TEMPERATURE_DEC)
...
working.df$ICU_APTT_INT <- ifelse(as.numeric(working.df$ICU_APTT_INT) >200, NA, working.df$ICU_APTT_INT)
...
working.df$ICU_PLATELETS_INT <- ifelse(as.numeric(working.df$ICU_PLATELETS_INT) >1000, NA, working.df$ICU_PLATELETS_INT)
...
working.df$ICU_PROTHROMB_INT <- ifelse(as.numeric(working.df$ICU_PROTHROMB_INT) >80, NA, working.df$ICU_PROTHROMB_INT)
...
working.df$ICU_RRT_DURATION_INT <- as.numeric(with(working.df, 
                                                     ifelse(ICU_RRT_DURATION_INT %in% c("ND", ""), NA, 
                                                            ICU_RRT_DURATION_INT)))
working.df$ICU_RRT_DURATION_INT <- as.numeric(with(working.df, 
                                                     ifelse(ICU_RRT_DIAL_YN==FALSE | is.na(ICU_SEDATION_YN), NA, 
                                                            ICU_RRT_DURATION_INT)))
...
working.df$ICU_TRACHEO_METHOD_RAD <- with(working.df, ifelse(ICU_TRACHEO_METHOD_RAD == 3, 
                                                             "Unknown", ICU_TRACHEO_METHOD_RAD))
...
#RESP_INTUBATED_YN
working.df$RESP_INTUBATED_YN <- ifelse(working.df$RESP_INTUBATED_YN == "", NA, working.df$RESP_INTUBATED_YN)
working.df$RESP_INTUBATED_YN <- ifelse(working.df$RESP_INTUBATED_YN == "ND", NA, working.df$RESP_INTUBATED_YN)
working.df$RESP_INTUBATED_YN <- ifelse(working.df$RESP_INTUBATED_YN == "1", "Yes", working.df$RESP_INTUBATED_YN)
working.df$RESP_INTUBATED_YN <- ifelse(working.df$RESP_INTUBATED_YN == "0", "No", working.df$RESP_INTUBATED_YN)
working.df$RESP_INTUBATED_YN <- as.factor(working.df$RESP_INTUBATED_YN)


#RESP_INTUBATED_ICU_STAY_YN
working.df$RESP_INTUBATED_ICU_STAY_YN <- ifelse(working.df$RESP_INTUBATED_ICU_STAY_YN == "", NA, working.df$RESP_INTUBATED_ICU_STAY_YN)
working.df$RESP_INTUBATED_ICU_STAY_YN <- ifelse(working.df$RESP_INTUBATED_ICU_STAY_YN == "ND", NA, working.df$RESP_INTUBATED_ICU_STAY_YN)
working.df$RESP_INTUBATED_ICU_STAY_YN <- ifelse(working.df$RESP_INTUBATED_ICU_STAY_YN == "1", "Yes", working.df$RESP_INTUBATED_ICU_STAY_YN)
working.df$RESP_INTUBATED_ICU_STAY_YN <- ifelse(working.df$RESP_INTUBATED_ICU_STAY_YN == "0", "No", working.df$RESP_INTUBATED_ICU_STAY_YN)
working.df$RESP_INTUBATED_ICU_STAY_YN <- as.factor(working.df$RESP_INTUBATED_ICU_STAY_YN)
...
#RESP_NI_VENT_YN
working.df$RESP_NI_VENT_YN <- ifelse(working.df$RESP_NI_VENT_YN == "", NA, working.df$RESP_NI_VENT_YN)
working.df$RESP_NI_VENT_YN <- ifelse(working.df$RESP_NI_VENT_YN == "0", "No", working.df$RESP_NI_VENT_YN)
working.df$RESP_NI_VENT_YN <- ifelse(working.df$RESP_NI_VENT_YN == "1", "Yes", working.df$RESP_NI_VENT_YN)
working.df$RESP_NI_VENT_YN <- ifelse(working.df$RESP_NI_VENT_YN == "2", "Unknown", working.df$RESP_NI_VENT_YN)
working.df$RESP_NI_VENT_YN <- as.factor(working.df$RESP_NI_VENT_YN)
...
#RESP_HFNC_YN
working.df$RESP_HFNC_YN <- ifelse(working.df$RESP_HFNC_YN == "", NA, working.df$RESP_HFNC_YN)
working.df$RESP_HFNC_YN <- ifelse(working.df$RESP_HFNC_YN == "0", "No", working.df$RESP_HFNC_YN)
working.df$RESP_HFNC_YN <- ifelse(working.df$RESP_HFNC_YN == "1", "Yes", working.df$RESP_HFNC_YN)
working.df$RESP_HFNC_YN <- ifelse(working.df$RESP_HFNC_YN == "2", "Unknown", working.df$RESP_HFNC_YN)
working.df$RESP_HFNC_YN <- as.factor(working.df$RESP_HFNC_YN)
...
#RESP_ECMO_YN
working.df$RESP_ECMO_YN <- ifelse(working.df$RESP_ECMO_YN == "", NA, working.df$RESP_ECMO_YN)
working.df$RESP_ECMO_YN <- ifelse(working.df$RESP_ECMO_YN == "NA", NA, working.df$RESP_ECMO_YN)
working.df$RESP_ECMO_YN <- ifelse(working.df$RESP_ECMO_YN == "0", "No", working.df$RESP_ECMO_YN)
working.df$RESP_ECMO_YN <- ifelse(working.df$RESP_ECMO_YN == "1", "Yes", working.df$RESP_ECMO_YN)
working.df$RESP_ECMO_YN <- ifelse(working.df$RESP_ECMO_YN == "2", "Unknown", working.df$RESP_ECMO_YN)
working.df$RESP_ECMO_YN <- as.factor(working.df$RESP_ECMO_YN)
...
working.df$RESP_PRONE_YN <- ifelse(working.df$RESP_PRONE_YN == "", NA, working.df$RESP_PRONE_YN)
working.df$RESP_PRONE_YN <- ifelse(working.df$RESP_PRONE_YN == "0", "No", working.df$RESP_PRONE_YN)
working.df$RESP_PRONE_YN <- ifelse(working.df$RESP_PRONE_YN == "1", "Yes", working.df$RESP_PRONE_YN)
working.df$RESP_PRONE_YN <- ifelse(working.df$RESP_PRONE_YN == "2", "Unknown", working.df$RESP_PRONE_YN)
working.df$RESP_PRONE_YN <- as.factor(working.df$RESP_PRONE_YN)  
...
working.df$RESP_VENT_ROUTINE_YN <- ifelse(working.df$RESP_VENT_ROUTINE_YN == "", NA, working.df$RESP_VENT_ROUTINE_YN)
working.df$RESP_VENT_ROUTINE_YN <- ifelse(working.df$RESP_VENT_ROUTINE_YN == "ND", NA, working.df$RESP_VENT_ROUTINE_YN)
working.df$RESP_VENT_ROUTINE_YN <- ifelse(working.df$RESP_VENT_ROUTINE_YN == "NA", NA, working.df$RESP_VENT_ROUTINE_YN)
working.df$RESP_VENT_ROUTINE_YN <- ifelse(working.df$RESP_VENT_ROUTINE_YN == "0", "No", working.df$RESP_VENT_ROUTINE_YN)
working.df$RESP_VENT_ROUTINE_YN <- ifelse(working.df$RESP_VENT_ROUTINE_YN == "1","Yes", working.df$RESP_VENT_ROUTINE_YN)
working.df$RESP_VENT_ROUTINE_YN <- as.factor(working.df$RESP_VENT_ROUTINE_YN)
...
## there are several "other", one per class of antibiotics (i.e. i named "other quinolones", "other Aminoglycosides", "other2"). Should these be grouped?
...
working.df$INF_ANTIBIO1_INT <- ifelse(working.df$INF_ANTIBIO1_INT == 23, "Amoxy + clavulanate", working.df$INF_ANTIBIO1_INT)
working.df$INF_ANTIBIO1_INT <- ifelse(working.df$INF_ANTIBIO1_INT == 24, "Pipera + tazo", working.df$INF_ANTIBIO1_INT)
...
working.df$INF_ANTIBIO1_INT <- ifelse(working.df$INF_ANTIBIO1_INT == 63, "Other Quinolones", working.df$INF_ANTIBIO1_INT)
...
working.df$INF_ANTIBIO1_INT <- ifelse(working.df$INF_ANTIBIO1_INT == 73, "Other Glycopeptides", working.df$INF_ANTIBIO1_INT)
...
working.df$INF_ANTIBIO1_INT <- ifelse(working.df$INF_ANTIBIO1_INT == 96, "Other2", working.df$INF_ANTIBIO1_INT)
...
working.df$INF_ANTIBIO2_INT <- ifelse(working.df$INF_ANTIBIO2_INT == 23, "Amoxy + clavulanate", working.df$INF_ANTIBIO2_INT)
working.df$INF_ANTIBIO2_INT <- ifelse(working.df$INF_ANTIBIO2_INT == 24, "Pipera + tazo", working.df$INF_ANTIBIO2_INT)
...
working.df$INF_ANTIBIO2_INT <- ifelse(working.df$INF_ANTIBIO2_INT == 63, "Other Quinolones", working.df$INF_ANTIBIO2_INT)
...
working.df$INF_ANTIBIO2_INT <- ifelse(working.df$INF_ANTIBIO2_INT == 73, "Other Glycopeptides", working.df$INF_ANTIBIO2_INT)
...
working.df$INF_ANTIBIO2_INT <- ifelse(working.df$INF_ANTIBIO2_INT == 96, "Other2", working.df$INF_ANTIBIO2_INT)
...
working.df$INF_ANTIBIO3_INT <- ifelse(working.df$INF_ANTIBIO3_INT == 23, "Amoxy + clavulanate", working.df$INF_ANTIBIO3_INT)
working.df$INF_ANTIBIO3_INT <- ifelse(working.df$INF_ANTIBIO3_INT == 24, "Pipera + tazo", working.df$INF_ANTIBIO3_INT)
...
working.df$INF_ANTIBIO3_INT <- ifelse(working.df$INF_ANTIBIO3_INT == 63, "Other Quinolones", working.df$INF_ANTIBIO3_INT)
...
working.df$INF_ANTIBIO3_INT <- ifelse(working.df$INF_ANTIBIO3_INT == 73, "Other Glycopeptides", working.df$INF_ANTIBIO3_INT)
...
working.df$INF_ANTIBIO3_INT <- ifelse(working.df$INF_ANTIBIO3_INT == 96, "Other2", working.df$INF_ANTIBIO3_INT)
...
working.df$INF_ANTIBIO4_INT <- ifelse(working.df$INF_ANTIBIO4_INT == 23, "Amoxy + clavulanate", working.df$INF_ANTIBIO4_INT)
working.df$INF_ANTIBIO4_INT <- ifelse(working.df$INF_ANTIBIO4_INT == 24, "Pipera + tazo", working.df$INF_ANTIBIO4_INT)
...
working.df$INF_ANTIBIO4_INT <- ifelse(working.df$INF_ANTIBIO4_INT == 63, "Other Quinolones", working.df$INF_ANTIBIO4_INT)
...
working.df$INF_ANTIBIO4_INT <- ifelse(working.df$INF_ANTIBIO4_INT == 73, "Other Glycopeptides", working.df$INF_ANTIBIO4_INT)
...
working.df$INF_ANTIBIO4_INT <- ifelse(working.df$INF_ANTIBIO4_INT == 96, "Other2", working.df$INF_ANTIBIO4_INT)
...
#INF_ANTIFUNG3_INT
#INF_ANTIFUNG4_INT
#Name of antifungal administered variable 1-4
## can't find the code for the drug list
...
working.df$REH_MOBIL_72H_YN <- ifelse(working.df$REH_MOBIL_72H_YN == 2, "Unknown", working.df$REH_MOBIL_72H_YN)
...
working.df$REH_MOBIL_VENT_72H_YN <- ifelse(working.df$REH_MOBIL_VENT_72H_YN == 2, "Unknown", working.df$REH_MOBIL_VENT_72H_YN)
...
working.df$OUTCOME_LD <- ifelse(working.df$OUTCOME_LD == 7, "Unknown", working.df$OUTCOME_LD)
...
anticoagulation_freetext.df <- read.csv('./dictionaries/anticoagulation_freetext_dictionary.csv')
...
antiplatelet_freetext.df <- read.csv('./dictionaries/antiplatelet_freetext_dictionary.csv')
